 ...
 ?>
   <div class="container">
    ...
    <form action="" method="post">
      ...
      <div class="form-group has-feedback">
        <input type="password" class="form-control" pattern="^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?!.*\s).*$" name='password' placeholder="Password">
    ...
    <a href="register.php" class="text-center">Create Account</a> <br>
